...
# load omics data
mfa_data <- read.csv(url("https://raw.githubusercontent.com/xaitorx/OPLS-DA_Integration/master/data/mfa_data_NEW.csv"), row.names = 1)
...
# annotate loadings
annotacion_todo <- read.csv(url("https://raw.githubusercontent.com/xaitorx/OPLS-DA_Integration/master/data/var_dim2_annot.csv"))
...
Reactome_all <- read.csv(url("https://raw.githubusercontent.com/xaitorx/OPLS-DA_Integration/master/data/Reactome_all.csv"), stringsAsFactors=FALSE)
